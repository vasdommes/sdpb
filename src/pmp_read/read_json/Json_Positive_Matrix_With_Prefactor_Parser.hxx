...
#include "sdpb_util/json/Json_Int64_Parser.hxx"
...
private:
  using BigFloat_Parser = TJson_Float_Parser<El::BigFloat>;
  using Boost_Float_Parser = TJson_Float_Parser<Boost_Float>;

  using BigFloat_Vector_Parser = Json_Vector_Parser<BigFloat_Parser>;
  using Damped_Rational_Parser = Json_Damped_Rational_Parser<Boost_Float_Parser>;
  ...
  Json_Int64_Parser max_num_poles_parser;
...
public:
  ...
  void reset_element_parsers(const bool skip) override
  {
    ...
    max_num_poles_parser.reset(skip);
