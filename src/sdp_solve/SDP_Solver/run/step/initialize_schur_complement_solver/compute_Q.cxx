  ...
  for(int rank = 0; rank < num_ranks_per_node; ++rank)
    {
      ...
      // TODO remove
      El::mpi::Barrier();
      El::Output("my_rank=", El::mpi::Rank(shared_memory_comm), " rank=", rank,
                 ", El::mpi::Broadcast(num_blocks_in_rank)");
